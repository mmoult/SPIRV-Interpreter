...
void Parser::addOption(Option* opt, std::string full_word, const std::string& description, const std::string& single) {
...
void Parser::printHelp(unsigned option_len, std::vector<std::string>& intro) {
